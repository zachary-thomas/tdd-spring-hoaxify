...
public class FileServiceTest {
    ...
    @Test
    public void cleanupStorage_whenOldFilesExist_removeFilesFromStorage() throws IOException {
    ...
    @Test
    public void cleanupStorage_whenOldFilesExist_removeFileAttachmentFromDatabase() throws IOException {
        String fileName = "random-file";
        String filePath = appConfiguration.getFullAttachmentsPath() + "/" + fileName;
        File source = new ClassPathResource("profile.png").getFile();
        File target = new File(filePath);
