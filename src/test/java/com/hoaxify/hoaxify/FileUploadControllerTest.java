...
// Contains @ExtendWith(SpringExtension.class) already
...
public class FileUploadControllerTest {
    ...
    public void uploadFile_withImageFromAuthorizedUser_fileAttachmentStoredWithFileType() {
        ...
        uploadFile(getRequestEntity(), FileAttachment.class);
        FileAttachment fileAttachment = fileAttachmentRepository.findAll().get(0);

        assertThat(fileAttachment.getFileType()).isEqualTo("image/png");
    }
